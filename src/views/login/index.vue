<template>
  <div class="login-container">
    <el-form autoComplete="on"
      ...
      <p class="title"
         style="font-size:28px;color:#000">欢迎登录·邓州市第一高级中学 </p>
      <h2 class="title"
          style="font-size:38px;color:#0053b5">班级管理系统</h2>
      <p style="text-align:center">{{loginType===1?'密码登录':'验证码登录'}}</p>
      <div v-if="loginType===1">
        ...
        <el-form-item>
          <el-button type="text"
                     style="width:100%;color:#000;border: 1px solid #333333;"
                     :loading="loading"
