  ...
  methods: {
    ...
    editView() {
      ...
      if (id) {
        axios
          .post(
            '/smartprint/print-room/subject/get-subject',
            qs.stringify({ subjectId: id })
          )
          .then(res => {
            console.log(res)
            if (res.data.code !== 0) return this.$message.error(res.data.msg)
    ...
    onEditSubmit() {
      ...
      axios
        .post(
          '/smartprint/print-room/subject/update-subject',
    ...
    handleDelete(index, { id }) {
      ...
      axios
        .post(
          '/smartprint/print-room/subject/delete-subject',
          qs.stringify({ subjectId: id })
        )
        .then(res => {
          if (res.data.code !== 0) return this.$message.error(res.data.msg)
    ...
    onAddSubmit() {
      ...
      axios
        .post(
          '/smartprint/print-room/subject/create-subject',
