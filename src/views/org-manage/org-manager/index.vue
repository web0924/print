<template>
  <div style=""
    ...
    <div class="box-flex">
      ...
      <div class="page-right border-gray">
        <div class="table-filter">
          <el-input v-model="filterPar.searchCondition"
                    placeholder="组织机构代码/机构名称"
                    clearable
          ...
          <el-table v-loading="tableDataLoading"
            ...
            <el-table-column label="组织机构代码"
              ...
              <template slot-scope="scope">
                <div class="td-nowrap"
                     :title="scope.row.organizationCode">
            ...
            <el-table-column prop="insManager"
                             label="机构管理员"
                             width="120">
            </el-table-column>
            <el-table-column prop="insManagerPhone"
                             label="管理员电话"
                             width="120">
            </el-table-column>
            ...
            <el-table-column fixed="right"
                             ...
                             width="160">
              <template slot-scope="scope">
                <el-switch :value="scope.row.isValid"
                           @change="updateState($event,scope.row)">
                </el-switch>
                <i class="el-icon-edit-outline icon-operate-st1"
                   style=""
                   title="编辑"
                   @click="editOrg(scope.row)"></i>
                <i class="el-icon-question icon-operate-st1"
                   style=""
                   title="查看部门"
                   @click="gotoUserdep(scope.row)"></i>
              </template>
    ...
    <!-- 机构弹窗 -->
    <org-dialog v-if="orgDialogVisible"
                :is-show="orgDialogVisible"
                :org-dialog-title="orgDialogTitle"
                :org-form-data="orgForm"
                :dic-arr="dicArr"
                @closeDialog="orgDialogVisible = false"
                @submitForm="submitOrgForm" />
